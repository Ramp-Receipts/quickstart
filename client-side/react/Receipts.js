// TODO: moment and numeral libs need to be installed
...
class Receipts extends Component {
  ...
  // TODO: Root URL for your server-side, leave empty if it's on the same (sub)domain as client-side
  rootUrl = '';
  ...
  loadCustomer() {
    fetch(this.rootUrl + '/receipts/customer')
      .then(res => res.json())
      .then(customer => {
        let customerEdit = {
          name: customer.name,
  ...
  saveCustomer(customer) {
    ...
    return fetch(this.rootUrl + '/receipts/customer', params)
      .then(res => res.json());
  }
